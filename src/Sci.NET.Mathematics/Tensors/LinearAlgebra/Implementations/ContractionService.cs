        ...
        where TNumber : unmanaged, INumber<TNumber>
    {
        ...
        _gradientAppenderService.AddGradientIfRequired(
            ...
            grad =>
            {
                ...
                var leftGrad = contractionService.Contract(
                    grad,
                    right,
                    leftInd,
                    nonContractedBAxes,
                ...
                return permutationService.Permute(leftGrad, permuteAxes, overrideRequiresGradient: false);
            },
            grad =>
            {
                var nonContractedAAxes = Enumerable
                ...
                var contractionService = TensorServiceProvider
                    .GetTensorOperationServiceProvider()
                    .GetContractionService();

                var permutationService = TensorServiceProvider
                    .GetTensorOperationServiceProvider()
