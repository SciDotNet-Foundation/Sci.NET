...
/// <summary>
/// A CPU compute device that does not support AVX instructions.
/// </summary>
public class NoAvxCpuComputeDevice : ICpuComputeDevice
{
    private static readonly CpuComputeDevice Instance = new(Guid.NewGuid(), "No AVX CPU");

    /// <summary>
    /// Initializes a new instance of the <see cref="NoAvxCpuComputeDevice"/> class.
    /// </summary>
    public NoAvxCpuComputeDevice()
    {
        Id = Instance.Id;
        Name = Instance.Name;
    ...
    public NoAvxCpuComputeDevice(Guid id, string name)
    {
        Name = name;
        Id = id;
    ...
    {
        return NoAvxManagedTensorBackend.Instance;
    }
